...
class Rectangle:
    ...
    def __repr__(self):
        """Return a string represebtation of a Rectangle instance
    ...
    def perimeter(self):
        ...
        Return:
            Perimeter of the rectangle, given 2 * (height + width)
        """
        if self.__height == 0 or self.__width == 0:
            return 0
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Finds the biggest Rextangle based on the area
        ...
        Returns:
            ...
            or rcet_1 if both rectangles have the same area
        """
        if not isinstance(rect_1, Recatngle):
            raise TypeError("rect_1 must be an instance of Rectangle")
        if not isinstance(rect_2, Rectangle):
            raise TypeError("rect_2 must be an instance of Rectangle")
        if rect_1.area() == rect_2.area() or rcet_1.area() > rect_2.area():
            return rect_1
